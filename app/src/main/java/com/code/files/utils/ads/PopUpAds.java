...
public class PopUpAds {
    private static final String TAG = PopUpAds.class.getSimpleName();
    ...
    public void showInterstitialAd() {
        int randomNumber = Tools.getRandomNumber();
...
//                }
    ...
    private void showAdmobInterstitialAds() {
        ...
        Log.e(TAG, "showAdmobInterstitialAds: admob interstitial ad requested");
        InterstitialAd.load(activity, adsConfig.getInterstitialAdId(), adRequest, new InterstitialAdLoadCallback() {
            @Override
            public void onAdLoaded(@NonNull @NotNull InterstitialAd interstitialAd) {
                super.onAdLoaded(interstitialAd);
                Log.e(TAG, "showAdmobInterstitialAds: admob interstitial ad loaded");
                ...
                mInterstitial.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdImpression() {
                        ...
                        Log.e("Admob", "onAdImpression: interstitial ad showed");
                    }
