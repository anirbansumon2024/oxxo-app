package com.code.files.nav_fragments;
...
import com.code.files.models.Movie;
...
public class FavoriteFragment extends Fragment {
    ...
    private void initComponent(View view) {
        ...
        mAdapter = new CommonGridAdapter(getContext(), list, PreferenceUtils.isMandatoryLogin(configViewModel));
